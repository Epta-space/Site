      ...
      <div class="row">
        <div class="col-md-6 d-flex">
          ...
          <div class="align-self-center">
            ...
            <p>
                Um acervo com todos os cursos já produzidos pela equipe, para você se capacitar e voar cada vez mais alto.
            </p>
          </div>

        </div> <!-- fim texto cursos-->
        <div class="col-md-6 d-none d-md-block">
          <img src="https://i.ibb.co/KFBVN2t/curso.jpg" width="100%">
        </div>
      </div>
    </div>
  </section><!-- fim cursos -->
        ...
        if ($resultCheck > 0) {
          while ($row = mysqli_fetch_assoc($result)) {
            echo "<div class='col-md-4 mt-4'>
                  <div class='zoom'>
                    <a class='transp' href='{$row["Link"]}'><img src='{$row["Imagem"]}' class='img-fluid'></a>
                    <h4>{$row["Titulo"]}</h4>
                    <p>{$row["Conteudo"]}<br>
                    <div id='duracao'> Duração: {$row["Duracao"]} horas</div>
                    </p>
                  </div>
                </div>";
          }
        } else {
          echo "Ainda não há nada por aqui, volte mais tarde =)";
        }
        ?>
