    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 d-flex">
          <!-- inicio texto projetos-->
          <div class="align-self-center">
            <h1 class="display-4">Projetos</h1>
            <p>Um pouco do histórico da equipe. Documentação dos projetos e pesquisas já finalizados ou ainda em andamento.</p>
          </div>

        </div> <!-- fim texto projetos-->
