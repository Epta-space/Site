...
<body>
  ...
  <div class="container">
    <div class="row ">
      ...
      $query = "SELECT * FROM blog WHERE id LIKE {$queries['id']}";
  ...
  <section class="caixa">
    ...
    <div class="container">
      <div class="row">
        ...
        $query = "SELECT * FROM blog WHERE Tags LIKE '{$queries['tags']}' ORDER BY id DESC LIMIT 3";
        $result = mysqli_query($conn, $query);
        $resultCheck = mysqli_num_rows($result);
        ...
        if ($resultCheck > 0) {
          while ($row = mysqli_fetch_assoc($result)) {
            ...
            <div class='zoom'>
              ...
              <a class='transp' href='pages/materiaBlog.php?id={$row['id']}&tags={$row['Tags']}'><img src='{$row['Imagem']}' class='img-fluid'></a>
