        ...
        <nav class="navbar navbar-expand-sm navbar-light bg-light">
            <div class="container-fluid">
              ...
              <a href="loja.php" class="nav-link">Loja </a>
                    ...
                    <form class="form-inline" action="../connections/pesquisar.php" method="POST">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 mt-4">
                    <div class="zoom">
                        <?php
                        $pesquisa = $_POST['Research'];

                        $query = "SELECT * FROM blog WHERE (
                                    Tags LIKE '%{$pesquisa}__%' OR
                                    Titulo LIKE '%{$pesquisa}__%' OR
                                    Conteudo LIKE '%{$pesquisa}__%' OR
                                    Subtitulo LIKE '%{$pesquisa}__%'
                                    ) ORDER BY id DESC";
